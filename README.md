...
|------|---------|-------------|
| **Claude Code** | 2.1.251 | Anthropic's AI coding CLI |
| **Gemini CLI** | 0.57.0 | Google's Gemini AI CLI |
| **OpenAI Codex** | 0.151.0 | OpenAI's Codex CLI |
| **Snakemake** | 9.26.1 | Workflow management system |
