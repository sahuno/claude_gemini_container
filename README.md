...
|------|---------|-------------|
| **Claude Code** | 2.1.175 | Anthropic's AI coding CLI |
| **Gemini CLI** | 0.46.0 | Google's Gemini AI CLI |
| **OpenAI Codex** | 0.139.0 | OpenAI's Codex CLI |
| **Snakemake** | 9.23.0 | Workflow management system |
