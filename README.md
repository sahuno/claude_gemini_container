...
|------|---------|-------------|
| **Claude Code** | 2.1.168 | Anthropic's AI coding CLI |
| **Gemini CLI** | 0.45.2 | Google's Gemini AI CLI |
| **OpenAI Codex** | 0.137.0 | OpenAI's Codex CLI |
| **Snakemake** | 9.22.0 | Workflow management system |
