...
|------|---------|-------------|
| **Claude Code** | 2.1.76 | Anthropic's AI coding CLI |
| **Gemini CLI** | 0.33.1 | Google's Gemini AI CLI |
| **OpenAI Codex** | 0.114.0 | OpenAI's Codex CLI |
| **Snakemake** | 9.17.1 | Workflow management system |
