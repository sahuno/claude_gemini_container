...
|------|---------|-------------|
| **Claude Code** | 2.1.240 | Anthropic's AI coding CLI |
| **Gemini CLI** | 0.56.0 | Google's Gemini AI CLI |
| **OpenAI Codex** | 0.149.0 | OpenAI's Codex CLI |
| **Snakemake** | 9.25.2 | Workflow management system |
