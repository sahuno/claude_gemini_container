...
## Current Versions (Updated: July 2026)

| Tool | Version | Description |
|------|---------|-------------|
| **Claude Code** | 2.1.217 | Anthropic's AI coding CLI |
| **Gemini CLI** | 0.51.0 | Google's Gemini AI CLI |
| **OpenAI Codex** | 0.145.0 | OpenAI's Codex CLI |
