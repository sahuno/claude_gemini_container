...
|------|---------|-------------|
| **Claude Code** | 2.1.221 | Anthropic's AI coding CLI |
| **Gemini CLI** | 0.53.1 | Google's Gemini AI CLI |
| **OpenAI Codex** | 0.146.0 | OpenAI's Codex CLI |
| **Snakemake** | 9.24.0 | Workflow management system |
